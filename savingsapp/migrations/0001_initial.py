...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('archive_status', models.CharField(blank=True, choices=[('ARCHIVED', 'ARCHIVED'), ('UNARCHIVED', 'UNARCHIVED')], max_length=200, null=True)),
                ('interest_rate', models.IntegerField(blank=True, default=5, null=True)),
                ('cycle_name', models.CharField(blank=True, max_length=200, null=True, unique=True)),
